...
**Live dashboard:** ((https://public.tableau.com/views/OntarioElectricityDemandWeatherTime-of-UseCostAnalysis2024/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link))
